...
def main():
    # User input file
    print("Please enter the name of the file you would like to use data from or leave blank to use the default file.")
    print("Note:\n- This only accepts .csv files\n- Make sure the file is in the same folder as this python file")
    ...
    while file != "":
        try:
            ...
            print("File not found, please check the spelling and where the file is located.")
            print(file)
            file = input("File name: ")
    ...
    # Data cleaning for default file
    if file == "dc_weather.csv":
